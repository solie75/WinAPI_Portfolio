// WinAPI_Portfolio.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
#include "pch.h"
#include "CEngine.h"
#include "framework.h"
#include "WinAPI_Portfolio.h"
...
const wchar_t* g_pTitle = L"WinApi_Protfolio";
                     ...
                     _In_ int       nCmdShow)
{
    ...
    CEngine::GetInst()->CEngineInit(g_hWnd, 1600, 900);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINAPIPORTFOLIO);
